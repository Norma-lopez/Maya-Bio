...
<html lang="es">
    <head>
        ...
        <title>Registro_Control_Acopio</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <br>
                        <div class="agregar">
							<a href="control.acopio.php" style="text-decoration: none;">Nuevo</a>
						</div>
                        <h1 class="mt-4">Registro de Control de Acopio</h1>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <?php
                                    ...
                                    $query = "SELECT * FROM controlacopio";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['cicloProductivo'];?></td>
                                        <td><?php echo $row['nombreProductor'];?></td>
                                        <td><?php echo $row['codigo'];?></td>
                                        
                                        
                                        <th><a href="editar_control_acopio.php?idControl=<?php echo $row['idControl']; ?>"><img src="../icon/edit.png" width: 40px ></a></th>
                                        <th><a href="eliminar.proceso.php?idControl=<?php echo $row['idControl']; ?>"><img src="../icon/delete.png" width: 40px;></a></th>
                                    </tr>
                                <?php
                                }
                                ?>

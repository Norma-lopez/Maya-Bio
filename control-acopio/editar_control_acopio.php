                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <?php
                            ...
                            $query = "SELECT * FROM controlacopio WHERE idControl = '$idControl'";
                                ...
                                <div class="contenedor-inputs">   
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control" name="nombreOrganizacion" placeholder="Nombre de la Organización" value="<?php echo $row ['nombreOrganizacion']; ?>" required />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Ciclo Productivo:</label>
                                            <input type="text" class="form-control" name="cicloProductivo" value="<?php echo $row ['cicloProductivo']; ?>" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nombreProductor" value="<?php echo $row ['nombreProductor']; ?>" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="cantidadEntregado" value="<?php echo $row ['cantidadEntregado']; ?>" required/>
                                        </div>
                                    </div>

                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Proyección actual Kg:</label>
                                            <input type="text" class="form-control" name="proyeccionActual" value="<?php echo $row ['proyeccionActual']; ?>" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>1ra:</label>
                                            <input type="number" name="primeraCantidad" class="form-control" value="<?php echo $row ['primeraCantidad']; ?>" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>2da:</label>
                                            <input type="number" name="segundaCantidad" class="form-control" value="<?php echo $row ['segundaCantidad']; ?>" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>3ra:</label>
                                            <input type="number" name="terceraCantidad" class="form-control" value="<?php echo $row ['terceraCantidad']; ?>" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>4º:</label>
                                            <input type="numer" name="cuartaCantidad" class="form-control" value="<?php echo $row ['cuartaCantidad']; ?>" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>5º:</label>
                                            <input type="numer" name="quintaCantidad" class="form-control" value="<?php echo $row ['quintaCantidad']; ?>" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label>Total entregado:</label>
                                            <input type="number" name="totalEntregado" class="form-control" value="<?php echo $row ['totalEntregado']; ?>" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="encargado" class="form-control" value="<?php echo $row ['encargado']; ?>" required/>
                                        </div>
                                    </div>

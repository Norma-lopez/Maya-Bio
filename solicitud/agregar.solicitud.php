            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <p><a href="solicitud.php">Solicitud</a> &raquo; Registro:</p>
                            ...
                            <?php
                                if (isset($_POST["enviar"])) {
                                    ...
                                    $insertar=mysqli_query($conexion, "INSERT INTO solicitud VALUES (
                                        NULL, 
                                        '$noSolicitud',
                                        '$nombreOrganizacion',
                                        '$lugar',
                                    ...
                                    echo "<h2 class='registrado'>Solicitud registrado con exito</h2>'";
                                }
                            ?>

                            <form action="#" method="POST" >
                                <p >Solicitud No. <input type="number" name="noSolicitud"></p>

                                <p>Nombre de la Organización <input type="text" name="nombreOrganizacion" size="40" required></p>

                                <p>Lugar <input type="text" name="lugar"size="40" required/>   
                                    Fecha <input type="date" name="fecha" size="40" /></p>

                                <p>Yo, <input type="text" name="nombreSocio" size="40" required/>   
                                    , con número de identificación <input type="text" name="noIdentificacion" size="40"required/>
                                    SOLICITO, la inspección de mis parcelas <input type="text" name="inspecParcelas" size="40" required/>
                                    , con los cultivos <input type="text" name="cultivos" size="40" required/>
                                    actuales, ubicada en <input type="text" name="ubicacion" size="40" required/>
                                    con las extensiones <input type="text" name="extensionesHa" size="40" required/>Ha.
                                </p>
                                <br>
                                ...
                                <div class="registro">
                                    ...
                                    <p>Nombre: <input type="text" name="recibeNombre" size="40" required></p>
                                    <p>Cargo: <input type="text" name="cargo" size="40" required></p>

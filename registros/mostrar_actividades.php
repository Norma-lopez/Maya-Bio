            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
						<hr>
						<div class="agregar">
							<a href="agregar-registro.php">Agregar </a>
						</div>
								...
								<table class="table table-bordered">
									<thead>
										<tr>
											...
											<th>Código Finca</th>
											<th>Código Productor</th>
											<th>Técnico/asesor </th>
                                            <th>Actividad</th>
                                            <th>Ciclo de cosecha</th>
                                            <th>Cantidad</th>
                                            <th>Fuente</th>
											<th>Acciones</th>
									...
									<tbody>
										<?php
											...
											$consulta=mysqli_query($conexion, "SELECT * FROM registroactividades");
											...
											while ($fila=mysqli_fetch_array($consulta)) {
												...
												<tr>
													...
													<td>
														<a href="modificar.php?idActividades=%s"><img src="../icon/edit.png" width: 40px ></a>
														<a href="eliminar.php?idActividades	=%s" onclick="return confirmacion()" ><img src="../icon/delete.png" width: 40px;></a>
													</td>
												</tr>
												', $fila["nombreOperacion"], $fila["nomProductor"], $fila["codigFinca"], $fila["codgProductor"], $fila["nombreTecnico"], $fila["actividades"], $fila["cicloCosecha"], $fila["cantidad"], $fila["fuente"], $fila["idActividades"], $fila["idActividades"]);
											}
										?>
									</tbody>
								</table>

                            ...
                            <?php
                                ...
                                if (isset($_GET["idProducto"])) {
                                    ...
                                    printf('
                                            ...
                                            <div class="contenedor-inputs">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="nombreProducto" required value="%s"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="productor" required value="%s"/>
                                                        </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="produccionEstimada" class="form-control" value="%s"/>
                                                        </div>
                                                </div>
                                                ...
                                                <td>
                                                    <input type="hidden" value="%s" name="idProducto">
                                                </td>
                                        ...
                                        ', $fila["nombreProducto"], $fila["productor"], $fila["superficie"], $fila["produccionEstimada"],  $fila["ubicacion"], $fila["idProducto"]);
                                }
                            ?>
                        </div>
                    </div>

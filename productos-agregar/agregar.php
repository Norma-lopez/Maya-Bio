            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Agregar nuevo producto</h1>
                        <div class="card mb-4">
                            <p><a href="productos.php">Productos</a> &raquo; Añadir:</p>
                            ...
                            <?php
                                if (isset($_POST["enviar"])) {
                                    ...
                                    $insertar=mysqli_query($conexion, "INSERT INTO productos VALUES (
                                        NULL, 
                                        '$nombreProducto',
                                        '$productor',
                                        '$superficie',
                                ...
                                <!-- <legend><em>Llena los campos del formulario</em></legend>-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="productor" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="produccionEstimada" class="form-control"/>
                                            </div>
                                    </div>
                                    ...
                                    <input type="reset" class="btn btn-danger" value="Borrar"> <br>

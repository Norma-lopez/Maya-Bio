										...
										<?php
											...
											while ($fila=mysqli_fetch_array($consulta)) {
												...
												<tr>
													...
													<td>%s</td>
													<td>
														<a href="editar.php?idProducto=%s"><img src="../icon/edit.png" width: 40px ></a>
														<a href="eliminar.php?idProducto=%s" onclick="return confirmacion()" ><img src="../icon/delete.png" width: 40px;></a>
													</td>
												</tr>
												', $fila["nombreProducto"], $fila["productor"], $fila["superficie"], $fila["produccionEstimada"], $fila["estado"], $fila["ubicacion"], $fila["idProducto"], $fila["idProducto"]);
											}
										?>
									</tbody>
								</table>

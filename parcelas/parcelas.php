            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <br><br>
                        <div class="agregar">
							<a href="agregar-parcelas.php">Agregar </a>
						</div>
                        <h1 class="mt-4">Lista de Parcelas</h1>
                            <div class="table-responsive">
								<table class="table table-bordered">
									<thead>
										<tr>
											<th>Socio/Productor</th>
											<th>Codigo Parcela</th>
											<th>Descripción</th>
											<th>Estado </th>
											<th>Ubicación</th>
                                            <th>Superficie (Ha)</th>
											<th>Propiedad de la Tierra</th>
                                            <th>Acciones</th>
									...
									<tbody>
										<?php
											...
											$consulta=mysqli_query($conexion, "SELECT * FROM parcelas");
											...
											while ($fila=mysqli_fetch_array($consulta)) {
												...
												<tr>
                                                    ...
                                                    <td>%s</td>
													<td>
														<a href="../parcelas/editar.php ?idParcelas=%s"><img src="../icon/edit.png" width: 40px ></a>
														<a href="../parcelas/eliminar.php?idParcelas=%s" onclick="return confirmacion()" ><img src="../icon/delete.png" width: 40px;></a>
													</td>
												</tr>
												', $fila["nombreSocio"], $fila["codigoParcela"], $fila["descripcion"], $fila["estado"], $fila["ubicacion"], $fila["superficie"], $fila["propiedadTierra"], $fila["idParcelas"], $fila["idParcelas"]);
											}
										?>
									</tbody>
							</table>   

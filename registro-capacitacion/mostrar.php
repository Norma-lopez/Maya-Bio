            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <br>
                        <div class="agregar">
							<a href="capacitaciones.php" style="text-decoration: none;">Nuevo</a>
						</div>
                        <h1 class="mt-4">Registro de Asistencias</h1>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <?php
                                    ...
                                    $query = "SELECT * FROM registrocapacitacion";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['nmbreOrganizacion'];?></td>
                                        <td><?php echo $row['tema'];?></td>
                                        <td><?php echo $row['fecha'];?></td>
                                        <td><?php echo $row['lugar'];?></td>
                                        
                                        
                                        <th><a href="modificar.php?idRegistro=<?php echo $row['idRegistro']; ?>"><img src="../icon/edit.png" width: 40px ></a></th>
                                        <th><a href="eliminar.php?idRegistro=<?php echo $row['idRegistro']; ?>"><img src="../icon/delete.png" width: 40px;></a></th>
                                    </tr>
                                <?php
                                }
                                ?>

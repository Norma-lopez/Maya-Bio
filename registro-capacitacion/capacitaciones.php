            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <form action="guardar-proceso.php" method="POST" enctype="multipart/form-data" class="formulario">
                                <div class="contenedor-inputs">
                                       
                                    <p>Logo:<input type="file" required name="logo" value="">   
                                        Nombre de la organizacion: <input type="text" required name="nmbreOrganizacion" placeholder="Nombre de la Organización" size="40" value=""/>  
                                    </p>  
                                    <div class="col-md-5">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nmbreInstructor" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="representateSCI" required/>
                                        </div>
                                    </div>

            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
						<hr>
						<div class="agregar">
							<a href="agregar.cosecha.php">Nuevo</a>
						</div>
                        
                        <h1 class="mt-4">Lista de Cosechas</h1>
								...
								<table class="table table-bordered">
									<thead>
										<tr>
											...
											<th>código de la finca</th>
											<th>Código del productor</th>
											<th>Producto a cosechar</th>
                                            <th>Sacos </th>
                                            <th>Kg</th>
                                            <th>Cajas</th>
                                            <th>Otro</th>
									...
									<tbody>
										<?php
											...
											$consulta=mysqli_query($conexion, "SELECT * FROM cosecha");
											...
											while ($fila=mysqli_fetch_array($consulta)) {
												...
												<tr>
                                                    ...
                                                    <td>%s</td>
													<td>
														<a href="editar.cosecha.php?idCosecha=%s"><img src="../icon/edit.png" width: 40px ></a>
														<a href="eliminar.php?idCosecha=%s" onclick="return confirmacion()" ><img src="../icon/delete.png" width: 40px;></a>
													</td>
												</tr>
												', $fila["nombreOperacion"], $fila["nmbreProductor"], $fila["codigoFinca"], $fila["codigoProductor"], $fila["productoCosecha"], $fila["sacos"], $fila["kg"], $fila["cajas"], $fila["otro"], $fila["mes"], $fila["semana"], $fila["productorEncargado"], $fila["idCosecha"], $fila["idCosecha"]);
											}
										?>
									</tbody>
								</table>
